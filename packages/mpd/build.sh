...
termux_step_pre_configure() {
	...
	rm -f /data/data/com.webdefault.corks/files/usr/etc/mpd.conf
}
...
termux_step_make_install () {
	...
	make install
	cp -f $TERMUX_PREFIX/share/doc/mpd/mpdconf.example /data/data/com.webdefault.corks/files/usr/etc/mpd.conf
