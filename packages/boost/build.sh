...
termux_step_make_install() {
	...
	echo "using clang : $TERMUX_ARCH : $CXX : <linkflags>-L/data/data/com.webdefault.corks/files/usr/lib ; " >> project-config.jam

	./b2 target-os=android -j${TERMUX_MAKE_PROCESSES} \
		include=/data/data/com.webdefault.corks/files/usr/include \
		include=/data/data/com.webdefault.corks/files/usr/include/python3.6m \
